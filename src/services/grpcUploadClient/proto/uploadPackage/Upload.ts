...
import type {
  UploadLargeRequest as _uploadPackage_UploadLargeRequest,
  UploadLargeRequest__Output as _uploadPackage_UploadLargeRequest__Output,
...
export interface UploadClient extends grpc.Client {
  ...
  UploadFileWithStream(
    ...
    options: grpc.CallOptions,
    callback: grpc.requestCallback<_uploadPackage_UploadResponse__Output>,
  ): grpc.ClientWritableStream<_uploadPackage_UploadLargeRequest>;
  UploadFileWithStream(
    metadata: grpc.Metadata,
    callback: grpc.requestCallback<_uploadPackage_UploadResponse__Output>,
  ): grpc.ClientWritableStream<_uploadPackage_UploadLargeRequest>;
...
export interface UploadDefinition extends grpc.ServiceDefinition {
  ...
  UploadFileWithStream: MethodDefinition<
    _uploadPackage_UploadLargeRequest,
    _uploadPackage_UploadResponse,
    _uploadPackage_UploadLargeRequest__Output,
    _uploadPackage_UploadResponse__Output
  >;
}
